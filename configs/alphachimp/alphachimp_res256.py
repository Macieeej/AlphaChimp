...
model = dict(
    ...
    init_cfg=dict(type='Pretrained', checkpoint='work_dirs/alphachimp/pretrain_res256.pth'),
    model_cfg=dict(
        type='mmdet.DINO',
        ...
        dn_cfg=dict(  # TODO: Move to model.train_cfg ?
            ...
            group_cfg=dict(dynamic=True, num_groups=None,
                           num_dn_queries=3)),  # TODO: half num_dn_queries
...
train_pipeline = [
    ...
    dict(type='RandomRescale', scale_range=((256, 256), (344, 344))),
