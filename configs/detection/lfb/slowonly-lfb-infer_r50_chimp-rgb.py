...
# model settings
lfb_prefix_path = 'data/ChimpACT_processed/lfb_half'
dataset_mode = 'test'  # ['train', 'val', 'test']
...
# dataset settings
dataset_type = 'LeipzigChimpActionDataset'
data_root = 'data/ChimpACT_processed'
anno_root = 'data/ChimpACT_processed/annotations/action'

ann_file_infer = f'{anno_root}/{dataset_mode}_action.csv'

exclude_file_infer = f'{anno_root}/{dataset_mode}_action_excluded_timestamps.csv'

label_file = f'{anno_root}/action_list.txt'

proposal_file_infer = (f'{anno_root}/{dataset_mode}_action_gt.pkl')
