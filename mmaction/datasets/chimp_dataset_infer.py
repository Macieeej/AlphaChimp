...
class ChimpDataset_Infer(BaseActionDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for idx in range(len(annot)):
            ...
            self.timestamp_start, self.timestamp_end = 0, int(ann['frame_len']) - 1
            for timestamp in range(int(ann['frame_len'])):
    ...
    def get_data_info(self, idx: int) -> dict:
        ...
        frame_len = int(data_info['frame_len'])
        timestamp_start, timestamp_end = 0, frame_len - 1
