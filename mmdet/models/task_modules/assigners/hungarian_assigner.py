...
class HungarianAssigner(BaseAssigner):
    ...
    def assign(self,
        ...
        assigned_gt_inds = torch.full((num_preds, ),
                                      ...
                                      dtype=torch.long,
                                      device=device)
        assigned_labels = torch.full((num_preds, self.num_classes),
                                     -1,
                                     dtype=torch.long,
                                     device=device)
        ...
        for match_cost in self.match_costs:
            ...
            #print(cost.size())
        # print('CLS', [x.size() for x in cost_list])
        cost = torch.stack(cost_list).sum(dim=0)
        # print('COSTSIZE', cost.size())
        ...
        # print('ALS', assigned_labels.size())
        # print('GLS', gt_labels.size())
        # print('MRI', matched_row_inds.size())
        # print('MCI', matched_col_inds.size())
